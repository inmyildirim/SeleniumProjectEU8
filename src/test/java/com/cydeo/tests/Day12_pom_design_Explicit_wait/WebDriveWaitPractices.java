...
public class WebDriveWaitPractices {
    ...
    @Test
    public void dynamic_load_7_page(){
        ...
        wait.until(ExpectedConditions.titleIs("Dynamic title"));//** important! learn it
    ...
    public void dynamic_load_1_test(){
        ...
        //3. Wait until loading bar disappears(invisibilityOf)
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(),10);
